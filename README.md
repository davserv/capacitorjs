...
```bash
git clone https://github.com/davserv/capacitorjs.git
```
...
### Precisa instalá-lo primeiro em seu projeto:

```bash
npm install @capacitor/android
```

Com o Capacitor configurado, adicione as plataformas desejadas. Por exemplo, 
...
<img src="" min-width="1px" max-width="1px" width="1px">
